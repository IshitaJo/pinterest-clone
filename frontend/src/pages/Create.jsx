        ...
        <div className="flex flex-wrap justify-center items-center gap-2 mt-10">
            <div className="flex items-center justify-center">
                <div className="flex flex-col items-center justify-center w-80 h-auto p-6 bg-white rounded-lg shadow-lg">
                    ...
                    <div onClick={handleClick} className="flex flex-col items-center justify-center h-full cursor-pointer">
                        <input
                            ref={inputRef}
                            type="file"
                            accept="image/*"
                    ...
                    <p className='mt-4 text-sm text-gray-400'>we recommend using high quality .jpg files but size less than 10mb</p>
                </div>
            </div>
            <div>
